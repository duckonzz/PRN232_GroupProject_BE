...
namespace GenderHealthCare.Repositories.Migrations
{
    ...
    [Migration("20250714054527_AddPaymentAndTestSlotRelation")]
    partial class AddPaymentAndTestSlotRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenderHealthCare.Entity.Payment", b =>
                {
                    b.HasOne("GenderHealthCare.Entity.TestSlot", "TestSlot")
                        .WithOne("Payment")
                        .HasForeignKey("GenderHealthCare.Entity.Payment", "ServiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
